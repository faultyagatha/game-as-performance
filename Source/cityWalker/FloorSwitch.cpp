...
AFloorSwitch::AFloorSwitch()
{
    ...
    TriggerBox->SetCollisionEnabled(ECollisionEnabled::QueryOnly); //register only overlap events
    TriggerBox->SetCollisionObjectType(ECollisionChannel::ECC_WorldStatic);
    TriggerBox->SetCollisionResponseToAllChannels(ECollisionResponse::ECR_Ignore); //do not fire any events except for a channel below
